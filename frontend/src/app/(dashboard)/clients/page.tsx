...
export default async function ClientsPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 p-6 flex flex-col justify-start items-center text-white relative">
      {/* Ambient glow */}
      <div className="absolute -top-40 -right-40 h-96 w-96 rounded-full bg-indigo-600/10 blur-[100px] pointer-events-none" />
      <div className="absolute bottom-0 left-0 h-72 w-72 rounded-full bg-violet-600/5 blur-[80px] pointer-events-none" />
