...
export default async function ProfilePage() {
  ...
  return (
    <div className="flex flex-col items-center justify-start py-8 relative">
      ...
      <div className="w-full max-w-2xl bg-card border border-card-border p-8 rounded-2xl backdrop-blur-md space-y-6 relative shadow-xl transition-all duration-300">
        ...
        <div className="space-y-6">
          {/* Header Card / Avatar */}
          <div className="p-5 rounded-xl bg-card-muted border border-card-border flex flex-col sm:flex-row items-center gap-4 select-none">
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="px-4 py-2.5 rounded-xl bg-card-muted/50 border border-card-border text-sm text-foreground/80 select-all font-medium">
                  {userName}
                </div>
              </div>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="px-4 py-2.5 rounded-xl bg-card-muted/50 border border-card-border text-xs font-mono text-muted-foreground select-all">
                  {session.user.id}
                </div>
              </div>
            </div>
            ...
            <div className="p-4 rounded-xl bg-card-muted/30 border border-card-border text-xs text-muted-foreground leading-relaxed mt-2 select-none">
              <span className="font-bold text-indigo-650 dark:text-indigo-400 block mb-1">Permisos asignados a su rol:</span>
